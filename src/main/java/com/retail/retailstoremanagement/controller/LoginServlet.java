...
@WebServlet("/login") public class LoginServlet extends HttpServlet{
 ...
 protected void doGet(HttpServletRequest q,HttpServletResponse p)throws ServletException,IOException{if("1".equals(q.getParameter("sessionChanged")))q.setAttribute("info","Tài khoản, mật khẩu hoặc trạng thái cửa hàng vừa thay đổi. Vui lòng đăng nhập lại.");if("1".equals(q.getParameter("superAdminReady")))q.setAttribute("info","Super Admin đã được khởi tạo. Đăng nhập với mã cửa hàng SYSTEM.");q.getRequestDispatcher("/WEB-INF/views/login.jsp").forward(q,p);}
